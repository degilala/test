...
if __name__ == "__main__":
    ...
    reg_data, reg_loader = get_register_dataloder((r'F:\peizhun\SPAC-Deformable-Registration-main\mydata\128', r'F:\peizhun\SPAC-Deformable-Registration-main\mydata\mov_128'))
    brain = SPAC(stn, device)

    brain.load_model('planner', cfg.ACTOR_MODEL)
    #brain.load_model('decoder', cfg.DECODER_MODEL_RL)
    brain.load_model('actor', cfg.ACTOR_MODEL_RL)
